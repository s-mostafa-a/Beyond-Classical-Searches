 ...
 */
public class HCrandomRestart extends Hill_Climbing{
    public HCrandomRestart(Problem problem){
        super(problem);
        go();
    }
    protected void go(){
        ...
        if(points.size() != 1) {
            ...
            if (index == -1) {
                ...
                way.add(problem.getRandomPoint());
                points.add(way.get(0));
                index = 0;
                min = 100;
            } else
        ...
        if(min == 0){
            ...
            System.out.println("injoori besh residam:");
