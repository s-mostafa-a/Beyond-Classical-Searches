 ...
 */
public class SAsub extends SimulatedAnnealing{
    public SAsub(Problem problem, double temprature){
    ...
    protected void go(){
        ...
        if(flag){
            ...
            System.out.println("gir kaardam to minimum mahali!");
        ...
        if(temprature - adad > 0)
            temprature = temprature - adad;
        else
        temprature = 0;
